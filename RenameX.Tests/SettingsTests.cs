    ...
    public class SettingsTests
    {
        ...
        public static IEnumerable<object?[]> GetWorkingDirectoryData()
        {
            return new object?[][]
            {
                ...
                new object?[] { "/tmp/doesnotexist", false, $"Directory \"{new DirectoryInfo("/tmp/doesnotexist").FullName}\" does not exist." }
            };
        }
        ...
        public static IEnumerable<object?[]> GetPrepentTextData()
        {
            return new object?[][]
            {
        ...
        [Theory]
        [MemberData(nameof(GetPrepentTextData))]
        ...
        public static IEnumerable<object?[]> GetGenerateRenamingStrategiesData()
        {
            return new object?[][]
            {
                new object?[] { null, null, false, new Type[0] },
                ...
                new object?[] { null, "", false, new Type[0] },
